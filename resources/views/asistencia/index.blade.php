                            ...
                            <table id="example1" class="table table-bordered table-striped table-sm">
                                <thead class="thead">
                                    <tr>
										...
										<th>Fecha</th>
										<th>Nombres y apellido del miembro</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('asistencias.destroy',$asistencia->id) }}" method="POST">
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" onclick= "return confirm('¿Desea eliminar esta asistencia?')" class="btn btn-danger btn-sm"><i class="fa fa-fw fa-trash"></i></button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
